# -*- coding: utf-8 -*-
"""
Created on Mon Jan 27 10:52:42 2020
...
for imagePath in imagePaths:
    ...
    cnts = cnts[0] if imutils.is_cv2() else cnts[1] cnts = sorted(cnts, key=cv2.contourArea, reverse=True)[:4] 49 cnts = contours.sort_contours(cnts)[0] 50 51 # initialize the output image as a "grayscale" image with 3 52 # channels along with the output predictions 53 output = cv2.merge([gray] * 3) 54 predictions = []
